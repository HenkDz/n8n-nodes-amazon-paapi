...
export class AmazonPaApiAgentTool implements INodeType {
    description: INodeTypeDescription = {
        displayName: 'Amazon Product Search (Agent Tool)',
        name: 'amazonPaApiAgentTool',
        ...
        defaults: {
            name: 'Amazon Product Search (Agent Tool)',
        },
